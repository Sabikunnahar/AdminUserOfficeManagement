                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('admin/leaves/controller/edit/'.$item->id) }}"><i class="ri-pencil-line"></i></a>

                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" id="delete" href="{{ url('admin/leaves/controller/delete/'.$item->id) }}"><i class="ri-delete-bin-line"></i></a>
