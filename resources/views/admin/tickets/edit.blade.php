          ...
          <div class="col-sm-12 col-lg-12">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   <form class="form-horizontal" action="{{ route('admin_ticket_update') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" value="{{ $edit->id }}">

                    <div class="form-group">
                        <label for="email">Edit Ticket Description</label>
                     ...
                     <div class="col-lg-12">
                        <div class="form-group">
                            <label for="">Edit assigned The ticket To</label>
                        
                            <select  name="ticket_assigned" value="{{('ticket_assigned') }}">
