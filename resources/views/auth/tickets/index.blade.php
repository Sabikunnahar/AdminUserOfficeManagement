        ...
        <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('tickets/edit/'.$item->id) }}"><i class="ri-pencil-line"></i></a>
                                        <a href=""></a>
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="col-sm-12 col-lg-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form class="form-horizontal" action="{{ route('ticket_store') }}" method="POST">
                            @csrf
