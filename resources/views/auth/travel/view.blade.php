                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $travel->firstItem()+$loop->index}}</td>
                                <td>{{ $item->travel_place }}</td>
                                <td>{{ $item->travel_start_date }}</td>
                                <td>{{ $item->travel_end_date }}</td>
                                <td>
                                    <div class="flex align-items-center list-user-action">
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ url('travel/edit/'.$item->id) }}"><i class="ri-pencil-line"></i></a>
                                    </div>
                                </td>
