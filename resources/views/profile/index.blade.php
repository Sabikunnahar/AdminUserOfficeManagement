                ...
                <div class="iq-card-body profile-page p-0">
                   <div class="profile-header">
                      <div class="cover-container">
                         <img src="{{ asset('public/admin') }}/images/bg-03.jpg"  alt="profile-bg" class="rounded img-fluid w-100">
                      </div>
                   ...
                   <div class="iq-card iq-card-block iq-card-stretch">
                      ...
                      <div class="iq-card-body">
                         <div class="about-info m-0 p-0">
                            <div class="row">
                               <div class="col-12"><p>I'm a Professional Web-developber</p></div>
                               <div class="col-12"><p>Something else</p></div>
